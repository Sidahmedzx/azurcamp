...
describe('EventParticipationService', () => {
  ...
  it('should get participation by userId', () => {
    ...
    const req = httpMock.expectOne('https://camp-backend-hmgdcvhthwdmf2dw.austriaeast-01.azurewebsites.net/api/event-participations/user/1');
  ...
  it('should update participation status', () => {
    ...
    const req = httpMock.expectOne('https://camp-backend-hmgdcvhthwdmf2dw.austriaeast-01.azurewebsites.net/api/event-participations/10/status?status=ATTENDED');
