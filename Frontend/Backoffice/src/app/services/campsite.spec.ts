...
describe('CampsiteService', () => {
  ...
  it('should fetch all campsites with pagination parameters', () => {
    ...
    const req = httpMock.expectOne('https://camp-backend-hmgdcvhthwdmf2dw.austriaeast-01.azurewebsites.net/api/campsites?page=1&size=10');
  ...
  it('should get a campsite by id', () => {
    ...
    const req = httpMock.expectOne('https://camp-backend-hmgdcvhthwdmf2dw.austriaeast-01.azurewebsites.net/api/campsites/5');
    req.flush(mockData);
  });
  ...
  it('should post new campsite data', () => {
    ...
    const req = httpMock.expectOne('https://camp-backend-hmgdcvhthwdmf2dw.austriaeast-01.azurewebsites.net/api/campsites');
  ...
  it('should call delete endpoint with correct id', () => {
    ...
    const req = httpMock.expectOne('https://camp-backend-hmgdcvhthwdmf2dw.austriaeast-01.azurewebsites.net/api/campsites/123');
